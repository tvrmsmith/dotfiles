...
# Note: known_hosts pinning is seeded at runtime by `_dsbx_install_helper_links`
# from the bind-mounted dotfiles repo — not at build time, since the dotfiles
# tree isn't cloned into the image anymore.
