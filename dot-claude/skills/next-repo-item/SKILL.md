---
name: next-repo-item
description: Pick the next ready beads item by dependency order and start work on it — sets up a Superset workspace and kicks off implementation. Handles ready-for-agent (with or without brief) and ready-for-human states. Redacted.Repo only.
